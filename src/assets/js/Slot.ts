  ...
  public async spin(): Promise<boolean> {
    const prizeData = {
      prizes: [
        ...
        { number: 45, name: 'PORTMEIRION BOTANIC GARDEN 18 PIECE SET - MADE IN ENGLAND', img: '' },
        { number: 46, name: 'PORTMEIRION BOTANIC GARDEN 18 PIECE SET - MADE IN ENGLAND', img: '' },
        { number: 47, name: 'APPLE AIRPODS PRO 2TH GEN', img: '' },
        { number: 48, name: 'APPLE AIRPODS PRO 2TH GEN', img: '' },
        { number: 49, name: 'PORTMEIRION BOTANIC ROSES 18 PIECE SET - MADE INENGLAND', img: '' },
        { number: 50, name: 'PORTMEIRION BOTANIC ROSES 18 PIECE SET - MADE INENGLAND', img: '' },
        { number: 51, name: 'GARMIN VIVOMOVE SPORT', img: '' },
        { number: 52, name: 'GARMIN VIVOMOVE SPORT', img: '' },
        { number: 53, name: 'GARMIN VIVOMOVE SPORT', img: '' },
        ...
        { number: 57, name: 'SKECHERS VOUCHER (WORTH RM 750.00)', img: '' },
        { number: 58, name: 'SKECHERS VOUCHER (WORTH RM 750.00)', img: '' },
        { number: 59, name: 'SKECHERS VOUCHER (WORTH RM 750.00)', img: '' },
        { number: 60, name: 'PORTMEIRION BOTANIC GARDEN 12 PIECE SQUARE SET', img: '' },
        { number: 61, name: 'PORTMEIRION BOTANIC GARDEN 12 PIECE SQUARE SET', img: '' },
        { number: 62, name: 'PORTMEIRION BOTANIC GARDEN 12 PIECE SQUARE SET', img: '' },
        ...
        { number: 95, name: 'SSF CASH VOUCHER (WORTH RM 700)', img: '' },
        { number: 96, name: 'SSF CASH VOUCHER (WORTH RM 700)', img: '' },
        ...
        { number: 110, name: 'SASA CASH VOUCHER (WORTH RM 500)', img: '' },
        { number: 111, name: 'SASA CASH VOUCHER (WORTH RM 500)', img: '' },
        { number: 112, name: 'SASA CASH VOUCHER (WORTH RM 500)', img: '' },
